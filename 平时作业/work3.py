...
# 调用示例
MLMethodFactory().create_ml_method("SVM")
EvaluationMetricFactory().create_evaluation_metric("MCC")
print("Generated data structure:", DataStructureGenerator(int=100, float=10.0, str=5).get_data_structure())
